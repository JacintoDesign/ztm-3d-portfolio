 ...
 *
 * **The strip is a rectangle again, and that is §3.1's kerb rather than a change of mind.**
 * It spent two sections as an L, notched in front of the bend wall, because a planar mirror
 * at grazing incidence looks *along* itself and the last strip of floor before that wall was
 * reflecting §3.6's cross street under its foot. §3.1's pavement now covers exactly that
 * floor, opaquely, so the notch had nothing left to hide — while the diagonal it cut kept
 * running past the wall's east corner into §3.1's open mouth, where there is no wall and no
 * kerb, and left **a wedge of bare base plane on the carriageway**. The lever was always
 * *whether reflective floor is visible*, and a kerb answers that better than a hole does.
 */
